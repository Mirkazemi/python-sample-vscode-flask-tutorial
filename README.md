[![Build Status](https://dev.azure.com/MirkazemiTest1/TestPython/_apis/build/status/Mirkazemi.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/MirkazemiTest1/TestPython/_build/latest?definitionId=1&branchName=master)
